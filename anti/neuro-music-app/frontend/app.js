...
const SONGS = [
  { id: 101, title: "Faded", artist: "Alan Walker", album: "Different World", dur: 212, icon: "music", grad: "linear-gradient(135deg,#093028,#237a57)", ytId: "60ItHLz5WEA", genre: "Electronic" },
  { id: 102, title: "On & On", artist: "Cartoon ft. Daniel Levi", album: "NCS Top Hits", dur: 208, icon: "headphones", grad: "linear-gradient(135deg,#2d1b69,#11998e)", ytId: "K4DyBUG242c", genre: "Electronic" },
  { id: 103, title: "The Spectre", artist: "Alan Walker", album: "NCS Top Hits", dur: 193, icon: "radio", grad: "linear-gradient(135deg,#1f1c2c,#928dab)", ytId: "AOeY-nDp7hI", genre: "Electronic" },
  ...
  { id: 105, title: "Lofi Hip Hop Radio", artist: "Lofi Girl", album: "Lofi Beats", dur: 0, icon: "coffee", grad: "linear-gradient(135deg,#1a1a3e,#4a4aaa)", ytId: "jfKfPfyJRdk", genre: "Lofi" },
  { id: 106, title: "Alone", artist: "Marshmello", album: "Joytime", dur: 199, icon: "disc", grad: "linear-gradient(135deg,#20002c,#cbb4d4)", ytId: "ALZHF5UqnU4", genre: "Electronic" },
  { id: 107, title: "Mortals", artist: "Warriyo ft. Laura Brehm", album: "NCS Top Hits", dur: 228, icon: "zap", grad: "linear-gradient(135deg,#000428,#004e92)", ytId: "yJg-Y5byMMw", genre: "Electronic" },
  { id: 108, title: "Fly Away", artist: "TheFatRat ft. Anjulie", album: "Warrior Songs", dur: 194, icon: "sparkles", grad: "linear-gradient(135deg,#360033,#0b8793)", ytId: "cMg8KaMdDYo", genre: "Gaming" },
  { id: 109, title: "Monody", artist: "TheFatRat ft. Laura Brehm", album: "Warrior Songs", dur: 290, icon: "sun", grad: "linear-gradient(135deg,#00b4db,#0083b0)", ytId: "B7xai5q_42g", genre: "Gaming" },
  { id: 110, title: "Invincible", artist: "DEAF KEV", album: "NCS Top Hits", dur: 273, icon: "activity", grad: "linear-gradient(135deg,#eb3349,#f45c43)", ytId: "J2X5mJ3HDYE", genre: "Electronic" },
  { id: 111, title: "Beautiful Now", artist: "Zedd ft. Jon Bellion", album: "True Colors", dur: 218, icon: "music", grad: "linear-gradient(135deg,#8f7bff,#d9c9ff)", ytId: "n1a7o44Wyp4", genre: "Electronic" },
  { id: 112, title: "True Colors", artist: "Zedd", album: "True Colors", dur: 228, icon: "star", grad: "linear-gradient(135deg,#54e0c7,#8f7bff)", ytId: "zN7Wd_d3g2k", genre: "Electronic" }
];
...
function onYTReady() {
  ytReady = true;
  if (ytPlayer) ytPlayer.setVolume(S.vol * 100);
